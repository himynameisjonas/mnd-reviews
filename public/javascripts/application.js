...
app.initialize_show_map = function() {
    var geocoder = new google.maps.Geocoder();
    var latlng = new google.maps.LatLng(app.office.settings.lat, app.office.settings.lang);
    var myOptions = {
        zoom: 15,
        center: latlng,
    ...
    var address = app.office.settings.address + ", " + app.office.settings.name;
...
app.initialize_index_map = function() {
    var geocoder = new google.maps.Geocoder();
    var latlng = new google.maps.LatLng(app.office.settings.lat, app.office.settings.lang);
    var myOptions = {
        zoom: 14,
